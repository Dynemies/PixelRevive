...
#                  >>>  SET YOUR PATHS HERE  <<<
#
#  Fill these in to run with no arguments at all:
#        python evaluate.py
#
#  Leave them empty to pass the paths on the command line instead:
#        python evaluate.py --input_dir IN --output_dir OUT
#
#  Command-line arguments always override whatever is set here.
#
#  Windows: keep the r prefix, or use forward slashes. Without it the \U
#  in C:\Users is read as a broken unicode escape and Python refuses to run.
# =====================================================================
...
WEIGHTS    = r""     # leave empty: checkpoints/best.pt is found automatically or 
...
def main():
    ...
    #   python evaluate.py --input_dir IN --output_dir OUT
    #   python evaluate.py --input IN --output OUT
